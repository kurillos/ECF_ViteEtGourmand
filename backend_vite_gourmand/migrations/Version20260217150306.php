 ...
 */
final class Version20260217150306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, date_commande DATETIME NOT NULL, statut VARCHAR(50) NOT NULL, date_prestation DATE NOT NULL, heure_livraison TIME NOT NULL, lieu_livraison VARCHAR(255) NOT NULL, nombre_personnes INT NOT NULL, frais_livraison DOUBLE PRECISION NOT NULL, total_ttc DOUBLE PRECISION NOT NULL, client_id INT NOT NULL, menu_id INT NOT NULL, INDEX IDX_6EEAA67D19EB6921 (client_id), INDEX IDX_6EEAA67DCCD7E912 (menu_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, titre_menu VARCHAR(50) NOT NULL, description_menu LONGTEXT NOT NULL, prix_menu NUMERIC(10, 2) NOT NULL, nb_personnes INT NOT NULL, regime VARCHAR(20) DEFAULT NULL, quantite_restante INT NOT NULL, image_url VARCHAR(255) DEFAULT NULL, allergenes LONGTEXT DEFAULT NULL, conditions LONGTEXT DEFAULT NULL, theme_id INT NOT NULL, INDEX IDX_7D053A9359027487 (theme_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE menu_plats ADD CONSTRAINT FK_14E6416DCCD7E912 FOREIGN KEY (menu_id) REFERENCES menu (id)');
